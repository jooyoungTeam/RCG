...
public:
	...
	float calcRelativeLeft(float left) { float relativeLeft = left - _left; return relativeLeft; }
	float calcRelativeTop(float top)   { float relativeTop = top - _top; return relativeTop; }
};
